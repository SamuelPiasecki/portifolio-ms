...
export function FeedPost({ title, excerpt, date, tags, url, src, alt }: FeedPostProps) {
  ...
  return (
    ...
    >
      ...
      {src && (
        ...
        >
          <Image styleSheet={{ width: '100%', marginTop: '29px', borderRadius: '12px' }} src={src} alt={alt} />
        </Button.Base>
      )}
    </Box>
  );
